...
if __name__ == "__main__":
    ...
    # save_dir = './fd_rlt4'
    img_list_fn = '/Users/jackie/data/mergeddata_filelist.txt'
    img_root_dir = '/Users/jackie/data/mergeddata'
    save_dir = '/Users/jackie/data/mergeddata/mergeddata_det_result'
